...
public class SSBlockAirNormalRender  implements ISimpleBlockRenderingHandler {

	final int renderID;
	
	public SSBlockAirNormalRender(int var1)
    {
        this.renderID = var1;
    }
	...
	public void renderInventoryBlock(Block block, int metadata, int modelId,
		...
		SSBlockAirNormalRender.renderInvNormalBlock(renderer, block, metadata);
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z,
		...
		SSBlockAirNormalRender.renderBreathableAir(renderer, block, world, x, y, z);
	        return true;
	}
