...
public class SpaceSkyRenderer extends IRenderHandler
{
    ...
    //private static final ResourceLocation moonTexture = new ResourceLocation("ss:textures/space/moon.png");
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc)
    {
		...
		{
			var12 = 30.0F;
			this.minecraft.renderEngine.bindTexture(sunTexture);
		...
		{
			var12 = 40.0F;
			this.minecraft.renderEngine.bindTexture(moonTexture);
    ...
    /*private Vec3 getCustomSkyColor()
    {
    	...
    	return Vec3.fakePool.getVecFromPool(0.0D, 0.0D, 0.0D);
    }*/
